...
local to_insert = {
	...
	},
	{
		...
		related_projectiles	= {"mods/grahamsperks/files/spells/material_pure.xml"},
	...
	},
	{
		...
		mana = 20,
		action 		= function()
			c.extra_entities = c.extra_entities .. "mods/grahamsperks/files/spells/rot.xml,data/entities/particles/tinyspark_green.xml,"
	...
	},
	{
		...
		related_projectiles	= {"mods/grahamsperks/files/spells/bubble_fire.xml", "mods/grahamsperks/files/spells/bubble_elec.xml", "mods/grahamsperks/files/spells/bubble_toxic.xml"},
		type 		= ACTION_TYPE_PROJECTILE,
