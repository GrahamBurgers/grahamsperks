...
add_spells_to_effect("magic_liquid_charm", { "GRAHAM_MIST_SWEET","GRAHAM_CIRCLE_SWEET" })
add_spells_to_effect("magic_liquid_berserk", { "GRAHAM_CIRCLE_ANGY" })
add_spells_to_effect("magic_liquid_teleportation", { "GRAHAM_TELEPORT" })
add_spells_to_effect("magic_liquid_unstable_teleportation", { "GRAHAM_TELEPORT" })
add_spells_to_effect("magic_liquid_mana_regeneration", { "GRAHAM_MANAHEART", "GRAHAM_PASSIVES" })
add_spells_to_effect("magic_liquid_protection_all", { "GRAHAM_SLICESHIELD", "GRAHAM_SHIELD_DRONE" })

-- pure liquid: various 'holy' or 'good' spells
   new_spell_material("graham_pureliquid", {"GRAHAM_MATERIAL_PURE", "GRAHAM_HOLY_BULLET", "GRAHAM_GUARDIAN_SHOT"})
-- hellblood: eeeeeevil
...
-- mundanium: sorta basic but not bad spells
   new_spell_material("graham_mundane", {"BUBBLESHOT", "BOUNCY_ORB", "BULLET", "SPITTER", "TINY_GHOST", "RUBBER_BALL", "GRAHAM_STASIS"})
...
-- coffee: movement related stuff for spells and player
   new_spell_material("graham_coffee", {"GRAHAM_COFFEE", "LONG_DISTANCE_CAST", "LASER_LUMINOUS_DRILL", "TELEPORT_PROJECTILE", "TELEPORT_PROJECTILE_SHORT", "GRAHAM_BREADCRUMB"})
