...
local enemies = EntityGetInRadiusWithTag(x, y, 120, "mortal") or {}
...
for i, enemy in ipairs(enemies) do
    ...
    if y < y2 and math.abs(x - x2) < 12 and RaytracePlatforms( x - 4, y, x2 + 4, y2) ~= true and EntityGetComponent(enemy, "PhysicsBodyComponent") == nil and whoshot ~= enemy then
